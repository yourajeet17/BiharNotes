...
<html>  
<head>
    <title>BiharNotes : Patna University MCA Semester II CS24 Assignment</title>
    <meta charset="utf-8">
        ...
        <div class="menu col-lg-2 col-md-2 col-4">
          <div class="dropdown">
            <div class="btn-group">
              ...
              <div class="dropdown-menu mega-menu3 bgddmenu">
    ...
    <div class="row">
      <div class="col-12 text-center">
        <?php
          ...
          $files = glob('files/sem2/Assignment/cs24_assig/*');

              natcasesort($files);

              foreach($files as $file) {
                 echo '<img class="imag" src="' . $file . '" />';
              }
        ?>      
      </div>
    </div>
...
if (event.ctrlKey && 'PpCcXxAa'.indexOf(event.key) !== -1) {
